              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="input-focus appearance-none block w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl placeholder-gray-400 focus:outline-none focus:border-indigo-500 transition-all"
